...
def main(args):
    ...
    if args.constrative:
        print("Constrative init")
        model.cross_attn.load_state_dict(torch.load('./mbin/cross_attn_dahi.pt',map_location="cpu"), strict=True)
        model.cross_attn.to(dtype=torch_dtype)
